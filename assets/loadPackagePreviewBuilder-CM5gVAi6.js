import{aq as b,ar as F,as as P,ab as de,at as _,au as h,av as Oe,h as De,b as ze,aw as Re,ax as Ge,ay as Be}from"./index-DgvhYXpQ.js";import{l as We}from"./loadPackagePreview-DWqc5Tph.js";function n(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function C(e,r=""){var o,a;return e?((a=(o=e.versionHistory)==null?void 0:o[e.versionHistory.length-1])==null?void 0:a.text)??e.yourVersion??e.originalText??r:r}function v(e,r,i,o){return o[e]?C(i,r):r}function pe(e,r,i){const o=typeof i=="number"?i:Number(i);if(Number.isFinite(o)){const a=e.versionAttributes[o];return(a==null?void 0:a.originalText)!=null?a.originalText:r.marketing.versionAttributes[o-1]??""}return""}function q(e){var r,i;return e?((i=(r=e.versionHistory)==null?void 0:r[e.versionHistory.length-1])==null?void 0:i.url)??e.currentUrl??"":""}function K(e){var r,i;return e?((i=(r=e.versionHistory)==null?void 0:r[0])==null?void 0:i.url)??e.currentUrl??"":""}function G(e,r,i,o){return(e.some(g=>o[g])?q(r):K(r))||i}function O(e){return/(?:^|[-_])(?:new|added|\d{10,})(?:$|[-_])/i.test(String(e))}function A(e){return e?!String(e.originalText??"").trim()&&!!C(e).trim():!1}function H(e){return e?" pdp-new-content":""}function N(e){return e?'<span class="pdp-new-badge">New</span>':""}function S(e){return e?" pdp-moved-content":""}function j(e){return e?'<span class="pdp-moved-badge">Moved</span>':""}function Ue(e,r,i){const o=i.featureTitles[e],a=i.features[e],p=i.featureGlossaries[e],g=C(o,(r==null?void 0:r.title)??"").trim(),c=C(a,(r==null?void 0:r.description)??"").trim(),s=C(p,(r==null?void 0:r.glossary)??"").trim();return!r||O(e)||A(o)||A(a)||qe(e)&&(Le(i.featureImages[e])||/^Feature\s+PBTFEA\d+$/i.test(g)||!c&&!s)}function M(e,r,i){return!!((e.sectionOrderChanges??[]).some(o=>o.kind===r&&o.rowId===i)||r==="specification"&&(e.specificationOrderChanges??[]).some(o=>o.rowId===i))}function B(e,r){return(e.sectionRemovalLog??[]).filter(i=>i.kind===r)}function J(e){return`<div class="pdp-removed-placeholder" ${b("removed")} ${F(e.rowId)}><span class="pdp-removed-badge">Removed</span><strong>${n(e.label)}</strong></div>`}function $(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/["\\#.:,[\]>+~*'=|^$(){}!]/g,"\\$&")}function Le(e){return!String(q(e)||K(e)||(e==null?void 0:e.currentUrl)||"").trim()}function qe(e){return/^PBTFEA\d+$/i.test(e)}function Ve(e,r){var i,o,a,p;if(typeof DOMParser>"u")return e;try{const c=new DOMParser().parseFromString(e,"text/html");if(!c.documentElement)return e;Je(c);const{formData:s,template:m}=r;return u(c,P("brand-concept"),((i=s.headerBrandConcept)==null?void 0:i.originalText)??`${s.marketingBrand||"Philips"} · ${s.marketingConcept||m.concept}`.trim(),s.headerBrandConcept),u(c,P("descriptor"),((o=s.headerDescriptor)==null?void 0:o.originalText)??(s.marketingDescriptor||m.descriptor),s.headerDescriptor),u(c,P("code-ctn"),((a=s.headerCtn)==null?void 0:a.originalText)??(s.marketingCtn||m.ctn),s.headerCtn),u(c,P("alphanumeric"),((p=s.headerAlphanumeric)==null?void 0:p.originalText)??(s.marketingAlphanumeric||m.alphanumeric||m.ctn),s.headerAlphanumeric),u(c,P("wow"),m.marketing.wow,s.marketingWow),u(c,P("subwow"),m.marketing.subWow,s.marketingSubWow),u(c,P("marketing-text"),m.marketing.marketingText,s.marketingText),Object.entries(s.versionAttributes).forEach(([d,x])=>{u(c,`#${$(`version-attr-${d}`)}`,pe(s,m,d),x)}),m.features.forEach(d=>{u(c,`#feature-title-${$(d.id)}`,d.title,s.featureTitles[d.id]),u(c,`#feature-text-${$(d.id)}`,d.description,s.features[d.id]),u(c,`#feature-glossary-${$(d.id)}`,d.glossary??"",s.featureGlossaries[d.id])}),Object.entries(s.featureTitles).forEach(([d,x])=>{const T=W(d,"feature-title-");u(c,`#feature-title-${$(T)}`,x.originalText??"",x)}),Object.entries(s.features).forEach(([d,x])=>{const T=W(d,"feature-text-");u(c,`#feature-text-${$(T)}`,x.originalText??"",x)}),Object.entries(s.featureGlossaries).forEach(([d,x])=>{const T=W(d,"feature-glossary-");u(c,`#feature-glossary-${$(T)}`,x.originalText??"",x)}),r.specItems.forEach(d=>{u(c,`#spec-title-${$(d.id)}`,d.name,s.specificationTitles[d.id]),d.kind!=="subsection"&&u(c,`#spec-text-${$(d.id)}`,d.value,s.specifications[d.id])}),Object.entries(s.specificationTitles).forEach(([d,x])=>{const T=W(d,"spec-title-");u(c,`#spec-title-${$(T)}`,x.originalText??"",x)}),Object.entries(s.specifications).forEach(([d,x])=>{const T=W(d,"spec-text-");u(c,`#spec-text-${$(T)}`,x.originalText??"",x)}),r.accessoryItems.forEach(d=>{u(c,`#accessory-title-${$(d.id)}`,d.name,s.accessoryConceptTitles[d.id]),u(c,`#accessory-text-${$(d.id)}`,d.value,s.accessories[d.id])}),r.awardItems.forEach(d=>{u(c,`#award-text-${$(d.id)}`,d.value,s.awards[d.id])}),r.disclaimerItems.forEach(d=>{u(c,`#disclaimer-${$(String(d.id))}`,d.text,s.disclaimers[d.id])}),_e(c,r),`<!doctype html>
${c.documentElement.outerHTML}`}catch{return e}}function Je(e){const r=e.createElement("style");r.textContent=`
  ...
  `,e.head.appendChild(r)}function u(e,r,i,o){const a=C(o,i);if(!o||a===i)return;const p=Ye(i,a);Array.from(e.querySelectorAll(r)).forEach(c=>{var m,d;const s=(d=(m=c.querySelector(".tooltiptext"))==null?void 0:m.textContent)==null?void 0:d.trim();c.classList.add("pdp-change-marker","pdp-change-marker--mixed"),c.setAttribute("data-pdp-change-label","Changed"),c.innerHTML=s?`<span class="textwithtooltip">${p}<span class="tooltiptext">${n(s)}</span></span>`:p})}function W(e,r){return e.startsWith(r)?e.slice(r.length):e}function _e(e,r){Object.entries(r.heroAssets??{}).forEach(([i,o])=>{i==="0"&&U(e,"#hero-block",o),U(e,`#hero-thumb-${Number(i)}`,o)}),Object.entries(r.formData.featureImages??{}).forEach(([i,o])=>{U(e,`#feature-${$(i)}`,o)}),Object.entries(r.formData.accessoryImages??{}).forEach(([i,o])=>{U(e,`#accessory-${$(i)}`,o)}),Object.entries(r.formData.awardImages??{}).forEach(([i,o])=>{U(e,`#award-${$(i)}`,o)})}function U(e,r,i,o){if(!i||!Ke(i))return;const a=e.querySelector(r);if(!a||a.querySelector(".pdp-image-change-note"))return;const p=q(i),g=a.matches("img")?a:a.querySelector("img");p&&g instanceof HTMLImageElement&&(g.src=p);const c=Xe(i);a.classList.add("pdp-image-change",`pdp-image-change--${c.className}`),a.setAttribute("data-pdp-image-request-kind",c.key),Qe(a,i)}function Ke(e){var r;return e.status==="amended"||e.versionHistory.length>1||e.thread.length>0||(((r=e.removalPins)==null?void 0:r.length)??0)>0}function Xe(e){const r=e.versionHistory.length>1||!!(K(e)&&q(e)&&K(e)!==q(e)),i=e.thread.some(o=>{var a,p;return!!((a=o.message)!=null&&a.trim())&&!((p=o.assetUrl)!=null&&p.trim())});return r&&i?{key:"new-image-brief",className:"new-brief"}:r?{key:"new-image",className:"new"}:{key:"brief-only",className:"brief"}}function Qe(e,r){const i=de(r.removalPins??[]);!i.length||e.querySelector("[data-pdp-removal-pin]")||i.forEach(o=>{const a=e.ownerDocument.createElement("span");a.className="pdp-removal-pin",a.dataset.pdpRemovalPin=o.label,a.textContent=o.label,a.title=`Removal marker ${o.label}`,a.setAttribute("style",`left:${_(o.x)*100}%;top:${_(o.y)*100}%;`),e.appendChild(a)})}function Ye(e,r){return r.trim()?Ze(e,r):'<span class="pdp-copy-removed-final">Copy removed from preview</span>'}function Ze(e,r){const i=et(e),o=r.split(/(\s+)/),a=o.filter(c=>c.trim()),p=tt(i,a);let g=-1;return o.map(c=>!c.trim()||(g+=1,p.has(g))?n(c):`<span class="pdp-redline-new">${n(c)}</span>`).join("")}function et(e){return String(e??"").match(/\S+/g)??[]}function tt(e,r){const i=e.map(se),o=r.map(se),a=Array.from({length:i.length+1},()=>Array(o.length+1).fill(0));for(let s=i.length-1;s>=0;s-=1)for(let m=o.length-1;m>=0;m-=1)a[s][m]=i[s]===o[m]?a[s+1][m+1]+1:Math.max(a[s+1][m],a[s][m+1]);const p=new Set;let g=0,c=0;for(;g<i.length&&c<o.length;)i[g]===o[c]?(p.add(c),g+=1,c+=1):a[g+1][c]>=a[g][c+1]?g+=1:c+=1;return p}function se(e){return e.toLowerCase().replace(/^[^\p{L}\p{N}]+|[^\p{L}\p{N}]+$/gu,"")}function Y(e){var ae,re,ie,oe,ne;const{ctn:r,pdpName:i,derivativeType:o,formData:a,template:p,heroAssets:g,approvedImages:c,approvedTextItems:s,specItems:m,accessoryItems:d,awardItems:x,disclaimerItems:T,includeTooltipMarkup:X=!1,includeChangeMarkers:f=!1}=e,w=(t,l)=>X?`<span class="textwithtooltip">${t}<span class="tooltiptext">${n(l)}</span></span>`:t,le=Array.from(new Set([...p.heroImages.map((t,l)=>l),...Object.keys(g).map(t=>Number(t)).filter(t=>Number.isFinite(t))])).sort((t,l)=>t-l),ee=G(["hero-0"],g[0],p.heroImages[0]??"",c),me=le.map(t=>{const l=G([`hero-${t}`],g[t],p.heroImages[t]??"",c),y=`Carousel image ${t+1}`,k=f?ce(g[t],!0):"";return`<div class="hero-thumb" id="hero-thumb-${t}" ${b("hero-image")} ${F(t)}>
...
`),Fe=d.map(t=>{const l=v(`accessory-title-${t.id}`,t.name,a.accessoryConceptTitles[t.id],s),y=v(`accessory-text-${t.id}`,t.value,a.accessories[t.id],s),k=G([`accessory-${t.id}`,t.id],a.accessoryImages[t.id],"",c),I=f&&(O(t.id)||A(a.accessoryConceptTitles[t.id])||A(a.accessories[t.id])),E=f&&M(a,"accessory",t.id);return`
      ...
      `}).join(`
`),Ce=x.map(t=>{const l=v(`award-text-${t.id}`,t.value,a.awards[t.id],s),y=G([`award-${t.id}`,t.id],a.awardImages[t.id],"",c),k=f&&(O(t.id)||A(a.awards[t.id])),I=f&&M(a,"award",t.id);return`
      ...
      `}).join(`
`),Ee=T.map(t=>{const l=v(`disclaimer-${t.id}`,t.text,a.disclaimers[t.id],s),y=f&&(O(t.id)||A(a.disclaimers[t.id])),k=f&&M(a,"disclaimer",String(t.id));return`<li id="disclaimer-${String(t.id)}" class="${`${H(y)}${S(k)}`.trim()}" ${b("disclaimer")} ${F(t.id)}>${N(y)}${j(k)}${w(n(l),"Disclaimer")}</li>`}).join(`
`),Pe=f?ce(g[0],!1):"",He=f?B(a,"specification").map(J).join(`
`):"",Ne=f?B(a,"accessory").map(J).join(`
`):"",Se=f?B(a,"award").map(J).join(`
`):"",je=f?B(a,"disclaimer").map(J).join(`
`):"";return`<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
    ...
    <section class="grid-2" id="header-grid" ${b("header-grid")}>
      <div id="hero-block" class="hero-carousel">
        <div class="hero-stage">
          ${ee?`<div class="hero-stage-image"><img class="hero" id="hero-image-0" ${h("hero-image")} src="${n(ee)}" alt="${n(r)} hero" />${Pe}</div>`:`<div class="hero" id="hero-image-0" ${h("hero-image")}>Image pending</div>`}
        </div>
...
</html>`}function ce(e,r){const i=de((e==null?void 0:e.removalPins)??[]);return i.length?i.map(o=>{const a=_(o.x)*100,p=_(o.y)*100,g=o.label||"?";return`<span class="pdp-removal-pin${r?" pdp-removal-pin--compact":""}" data-pdp-removal-pin="${n(g)}" style="left:${a}%;top:${p}%;" title="Removal marker ${n(g)}">${n(g)}</span>`}).join(""):""}async function dt(e){const r=await Oe({mode:"load",derivativeType:e.derivativeType,ctn:e.ctn,changelogVersion:e.versionNumber,pdpName:e.pdpName,asanaTaskGid:e.taskGid,templateRegistryTaskGid:null}),i=await We(e.taskGid,e.sourceRow),o={ctn:e.ctn,pdpName:e.pdpName,derivativeType:e.derivativeType,formData:r.formData,template:r.syntheticTemplate,heroAssets:r.heroAssets,approvedImages:r.approvedImages,approvedTextItems:r.approvedTextItems,specItems:r.specItems,accessoryItems:r.accessoryItems,awardItems:r.awardItems,disclaimerItems:r.disclaimerItems,includeTooltipMarkup:e.includeTooltipMarkup,includeChangeMarkers:!0},a=Ve(Y(o),o),p=await at(e,r.extensions);return{htmlPreview:a,baselinePreview:(p==null?void 0:p.html)??Y({ctn:e.ctn,pdpName:e.pdpName,derivativeType:e.derivativeType,formData:r.formData,template:r.syntheticTemplate,heroAssets:r.heroAssets,approvedImages:{},approvedTextItems:{},specItems:r.specItems,accessoryItems:r.accessoryItems,awardItems:r.awardItems,disclaimerItems:r.disclaimerItems,includeTooltipMarkup:e.includeTooltipMarkup}),baselineLabel:(p==null?void 0:p.label)??"See Original - Reconstructed from saved source data",changeSummaryRows:i.changeSummaryRows,details:i}}async function at(e,r){var a,p;const i=rt(r),o=Be();if(!i||!o)return null;try{const g=await De(i),c=ze(g),s=(p=(a=c.get(o))==null?void 0:a.text_value)==null?void 0:p.trim();if(!s)return null;const m=Re(JSON.parse(s),{derivativeType:e.derivativeType,ctn:it(c,Ge())||e.ctn,changelogVersion:e.versionNumber});return{label:"See Original - Template Registry JSON",html:Y({ctn:e.ctn,pdpName:e.pdpName,derivativeType:e.derivativeType,formData:m.formData,template:m.syntheticTemplate,heroAssets:m.heroAssets,approvedImages:{},approvedTextItems:{},specItems:m.specItems,accessoryItems:m.accessoryItems,awardItems:m.awardItems,disclaimerItems:m.disclaimerItems,includeTooltipMarkup:e.includeTooltipMarkup})}}catch{return null}}function rt(e){const r=Z(e==null?void 0:e.htmlDelta),i=Z(r==null?void 0:r.source);return L(i,["templateTaskGid"])||L(r,["templateTaskGid"])||L(e==null?void 0:e.htmlRegistrySource,["templateTaskGid"])||L(e==null?void 0:e.htmlImport,["templateTaskGid"])||L(e==null?void 0:e.asana,["templateTaskGid"])}function it(e,r){var o,a;return((a=(o=e.get(r))==null?void 0:o.text_value)==null?void 0:a.trim())||null}function L(e,r){const i=Z(e);if(!i)return null;for(const o of r){const a=typeof i[o]=="string"||typeof i[o]=="number"?String(i[o]).trim():"";if(a)return a}return null}function Z(e){return e&&typeof e=="object"&&!Array.isArray(e)?e:null}export{dt as buildLoadPackagePreview};
